...
import { ImportsAngularMaterial } from '../../shared/sharedImports';


@Component({
  selector: 'seed-container',
  standalone: true,
  imports: [CornComponent, SunflowerComponent, AnimationPotComponent, SeedBlueberryComponent, ...ImportsAngularMaterial],
